...
class SendMail extends Controller
{
    ...
    public function EmailInvite(){
       ...
       // Email message with HTML content
        ...
        $message .= '<a href="' . base_url() . '/onboard?center=' . $center . '&role=introducer&id=' . $encode . '" style="background-color: #007bff; color: #fff; text-decoration: none; padding: 10px 20px; border-radius: 5px; display: inline-block;">Complete Onboarding</a>';
        $message .= '</div>';
