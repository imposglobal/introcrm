  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="<?php echo base_url('/dashboard'); ?>"><b>ECO4</b> Portal</a>
        <a class="navbar-brand brand-logo-mini" href="<?php echo base_url('/dashboard'); ?>"><b>ECO4</b></a>
      </div>
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              <input style="border-radius: 10px; width:500px" type="text" class="bg-light text-dark form-control-sm border rounded-left px-4 border-rounded" id="searchQuery" placeholder="Check Duplicate Email or Mobile No" aria-label="search" aria-describedby="search">
              <div class="input-group-prepend rounded-right hover-cursor bg-primary text-white px-4" id="duplicatechk">
